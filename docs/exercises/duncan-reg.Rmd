...
```{r Duncan, class.source = 'fold-show'}
...
```{r read-duncan, eval=FALSE, class.source = 'fold-show'}
library(car)
data(Duncan, package="carData")
```
...
```{r spm, h=6, w=6, class.source = 'fold-show'}
...
```{r duncan.mod, class.source = 'fold-show' }
