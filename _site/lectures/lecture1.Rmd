...
author: 'Michael Friendly'
  <a href="http://github.com/friendly"><i class="fa fa-github fa-fw"></i>&nbsp; friendly</a><br> 
  <a href="http://twitter.com/friendly"><i class="fa fa-twitter fa-fw"></i>&nbsp; @friendly</a><br> 
institute: "York University"
date: 'Oct. 2020 (updated: `r Sys.Date()`)<br><br>
  `r icon::fa("link")` [bit.ly/MLF-VisMLM](https://bit.ly/MLF-VisMLM)<br>
  `r icon::fa("twitter")` [datavisFriendly](https://twitter.com/datavisFriendly)"'
output:
...
- R, version 3.6 or later. Download from [CRAN](https://cran.r-project.org/)
- I recommend (& will use) the  [RStudio IDE](https://www.rstudio.com/products/rstudio/)

- A variety of R packages.  Details on the course web page, but the main ones are:
...
- OK, I did my analysis, made my tables ...
