...
* Email: friendly AT yorku DOT ca `r icon::fa("envelope-square")`
* Twitter: [datavisFriendly](http://twitter.com/datavisFriendly) `r icon::fa("twitter")`
* Office: 226 BSB
* Course web site: [https://friendly.github.io/VisMLM-course/](https://friendly.github.io/VisMLM-course/)

## Dates / Location

*Dates/ Time* Thurs: Oct 22, 29, Nov 5; 1pm - 4pm
*Zoom*
