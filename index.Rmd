...
### Learning more `r icon::fa("chalkboard-teacher")`
...
### Materials:
- **Lecture notes**: [1up PDF](lectures/lecture2.pdf) || [4up PDF](lectures/lecture2-2x2.pdf) || `r icon::fa("video", color="red")` [video](https://www.dropbox.com/s/ngzbxafd91oaosd/VisMLM-Lecture2.mp4?dl=0)
- **Lab exercise**:
