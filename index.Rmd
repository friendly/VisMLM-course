...
broom, candisc, car, corrgram, dplyr, effects, ggplot2, glue, heplots, knitr, learnr, MASS, modelsummary, palmerpenguins, stargazer, rgl, tidyverse, visreg

You can install all required R packages at once by running the script [install-vismlm-pkgs.r](Rinstall-vismlm-pkgs.r).
Alternativelty, use the following code in the R console:
...
- **Lab exercise**: 
  + Visualizing MMRA Models [rohwer-mmra.html](exercises/duncan-reg.html) || [rohwer-mmra.R](exercises/rohwer-mmra.R)
